        ...
        <div class="table-responsive">
          <table id="organizations" class="table table-hover display mb-30 dataTable no-footer" style="cursor: pointer;" role="grid">
            ...
            <tr role="row" class="odd">
              ...
              <td tabindex="1">{{$organization->archive->name}}</td>
            ...
            @if($editable)
              <td tabindex="1">
                ...
                data-desc="{{$organization->desc}}"  
                data-archive="{{$organization->archive_id}}" 
                data-license="{{$organization->license}}" 
